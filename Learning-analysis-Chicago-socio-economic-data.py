...
get_ipython().run_line_magic('sql', 'select count(*) as Number_of_rows from chicago_socioeconomic_data')
...
get_ipython().run_line_magic('sql', 'select count(*) as hardship_index_greater_50 from chicago_socioeconomic_data where hardship_index>50')
...
get_ipython().run_line_magic('sql', 'select MAX(hardship_index) as maximum_value_hardship_index from chicago_socioeconomic_data')
